...
const h1_public_mint = "Welcome to Handsdrawing lab!";
...
const p_public_mint = "Handsdrawing Official collection minting is now open! 🎉 Max The GAS fee in case the transaction dont work ⛽";
const button_presale_coming_soon = "Get on the Whitelist";
const button_presale_mint_whitelisted = "Mint Your Super Rare Special NFT";
